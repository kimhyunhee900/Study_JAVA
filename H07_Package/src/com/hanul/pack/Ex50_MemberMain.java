...
import com.hanul.geometry.Ex49_Member;    // Ex49_Member는 그것만 임포트. *로 하면 모든것을 임포트
...
public class Ex50_MemberMain {
	...
	public static void main(String[] args) {
		...
		Ex49_Member sim = new Ex49_Member("심청","hanul002","sim1234","010-123-456");
		printMb(sim);
...
//	}
	...
	static void printMb(Ex49_Member mb) {
